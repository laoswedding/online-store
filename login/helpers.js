...
const IMAGE_BASE_URL =
  "https://raw.githubusercontent.com/laoswedding/online-store/main/";
...
const STRINGS = {
  en: {
    ...
    "form.errStock":
      "Enter a stock quantity of 0 or more, using whole numbers.",
    "form.errLinks":
      "Links must start with http:// or https://, or be a path like images/photo.jpg.",
    ...
    "pw.hint":
      "Use at least 10 characters. If you’re signed in on other devices, you’ll need to sign in again there.",
    ...
    "ship.bodyShort":
      "Not enough stock: {list}. Shipping will take stock below zero. It can’t be undone.",
    "toast.shipped": "Order shipped",
    "toast.notFound": "Not found in inventory: {ids}",
    "cancel.title": "Cancel order #{id}?",
    "cancel.body":
      "The order is marked as cancelled. Stock doesn’t change, because units only leave inventory when an order ships.",
    ...
    "sal.item": "Item {id}",
    "sal.note":
      "Sales are counted when an order ships. Days shown are the day each order was placed, because the sheet doesn’t record ship dates.",
    "err.scriptUrl":
      "Set SCRIPT_URL at the top of the script to your web app address.",
    "err.network":
    ...
    "srv.noRole":
      "Your account has no valid role. Ask the person who manages access.",
  ...
  lo: {
    ...
    "form.errLinks":
      "ລິ້ງຕ້ອງເລີ່ມດ້ວຍ http:// ຫຼື https:// ຫຼື ເປັນທີ່ຢູ່ເຊັ່ນ images/photo.jpg.",
    ...
    "pw.hint":
      "ໃຊ້ຢ່າງໜ້ອຍ 10 ຕົວອັກສອນ. ຖ້າທ່ານເຂົ້າສູ່ລະບົບຢູ່ອຸປະກອນອື່ນ ທ່ານຈະຕ້ອງເຂົ້າສູ່ລະບົບຢູ່ບ່ອນນັ້ນອີກຄັ້ງ.",
    ...
    "ship.body":
      "ຈະຫັກຈຳນວນສິນຄ້າທີ່ສັ່ງອອກຈາກສະຕັອກ ແລະ ໝາຍຄຳສັ່ງຊື້ວ່າຈັດສົ່ງແລ້ວ. ບໍ່ສາມາດຍ້ອນກັບໄດ້.",
    "ship.bodyShort":
      "ສະຕັອກບໍ່ພໍ: {list}. ການຈັດສົ່ງຈະເຮັດໃຫ້ສະຕັອກຕ່ຳກວ່າສູນ. ບໍ່ສາມາດຍ້ອນກັບໄດ້.",
    "toast.shipped": "ຈັດສົ່ງຄຳສັ່ງຊື້ແລ້ວ",
    "toast.notFound": "ບໍ່ພົບໃນສາງ: {ids}",
    "cancel.title": "ຍົກເລີກຄຳສັ່ງຊື້ #{id} ບໍ?",
    "cancel.body":
      "ຄຳສັ່ງຊື້ຈະຖືກໝາຍວ່າຍົກເລີກ. ສະຕັອກບໍ່ປ່ຽນແປງ ເພາະສິນຄ້າຈະຖືກຫັກອອກເມື່ອຈັດສົ່ງເທົ່ານັ້ນ.",
    ...
    "sal.ariaDay":
      "ລາຍຮັບແຍກຕາມວັນ. ວັນທີ່ດີທີ່ສຸດແມ່ນ {label} ເຊິ່ງໄດ້ {amount}.",
    "sal.ariaMonth":
      "ລາຍຮັບແຍກຕາມເດືອນ. ເດືອນທີ່ດີທີ່ສຸດແມ່ນ {label} ເຊິ່ງໄດ້ {amount}.",
    ...
    "sal.item": "ສິນຄ້າ {id}",
    "sal.note":
      "ຍອດຂາຍນັບເມື່ອຄຳສັ່ງຊື້ຖືກຈັດສົ່ງ. ວັນທີ່ສະແດງແມ່ນວັນທີ່ສັ່ງຊື້ ເພາະຊີດບໍ່ໄດ້ບັນທຶກວັນຈັດສົ່ງ.",
    "err.scriptUrl":
      "ຕັ້ງຄ່າ SCRIPT_URL ຢູ່ເທິງສຸດຂອງສະຄຣິບໃຫ້ເປັນທີ່ຢູ່ເວັບແອັບຂອງທ່ານ.",
    "err.network":
      "ບໍ່ສາມາດເຊື່ອມຕໍ່ເຊີບເວີໄດ້. ກະລຸນາກວດອິນເຕີເນັດ ແລ້ວລອງໃໝ່.",
    ...
    "srv.noRole":
      "ບັນຊີຂອງທ່ານບໍ່ມີບົດບາດທີ່ຖືກຕ້ອງ. ກະລຸນາຕິດຕໍ່ຜູ້ຈັດການສິດການເຂົ້າເຖິງ.",
...
function t(key, vars) {
  ...
  return vars
    ? str.replace(/\{(\w+)\}/g, (m, name) => (name in vars ? vars[name] : m))
    : str;
}
...
const hasOtherScheme = (u) =>
  /^[a-z][a-z0-9+.\-]*:/i.test(u) && !/^https?:\/\//i.test(u);
...
function messageOf(err) {
  ...
  return (
    raw.replace(/^(Uncaught\s+)?Error:\s*/i, "") ||
    "Something went wrong. Try again."
  );
}
const isSessionError = (err) =>
  /session expired|jwt expired|invalid jwt|not authenticated/i.test(
    messageOf(err),
  );
...
function fmtMoney(n) {
  ...
  try {
    ...
    return `₭${moneyFmt[key].format(n)} ${CURRENCY}`;
  } catch (e) {
    return `${whole ? String(n) : n.toFixed(2)} ${CURRENCY}`;
  }
}
